 ...
 * "minecraft.jar Patch Replacement":http://mc.funky-clan.de/minecraft.jar (~ 1mb)
 * "mc_architect.jar Runnable jar file":http://mc.funky-clan.de/mc_architect.jar (~ 0.2mb)
...
<pre><code>
  $HOME/.minecraft/bin> mvn install:install-file -Dfile=minecraft.jar -DgroupId=net.minecraft -DartifactId=minecraft-client -Dversion=1.2.02 -Dpackaging=jar
  $HOME/.minecraft/bin> mvn install:install-file -Dfile=lwjgl.jar -DgroupId=net.minecraft -DartifactId=lwjgl -Dversion=1.2.02 -Dpackaging=jar
