 ...
 * "mc_architect.jar Runnable jar file (latest, 0.3)":http://mc.funky-clan.de/mc_architect-0.3.jar (~ 4.2mb)
 * "mc_architect.jar Runnable jar file (stable)":http://mc.funky-clan.de/mc_architect.jar (~ 1.6mb)
