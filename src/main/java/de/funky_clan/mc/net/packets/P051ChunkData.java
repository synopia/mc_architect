 ...
 * @author synopia
 */
public class P051ChunkData extends BasePacket {
    ...
    public P051ChunkData() {}

    public P051ChunkData(byte source, int x, int y, int z, int sizeX, int sizeY, int sizeZ, byte[] data) {
        super( source );
        this.x     = x;
        this.y     = y;
        this.z     = z;
